  ...
  Settings: {
    ...
    Sync: {
      ...
      Config: {
        ...
        Encrypt: {
          Title: "Encrypt",
          SubTitle: "Encrypt backup data",
          Password: "Password",
          PasswordSubTitle: "Password for encrypting backup data",
        },
      },
    ...
    CustomModelConfig: {
      ...
      SubTitle: "Visual configuration for model list customization",
      ...
      EmptyDeploymentName: "Deployment name cannot be empty",
      NoItems: "No custom model configurations yet",
      RawText: "Raw configuration text",
      Empty: "(empty)",
      TextMode: "Text Mode",
      VisualMode: "Visual Mode",
      TextPlaceholder:
        "Enter custom model configuration, e.g.: +llama,+claude-2,-gpt-3.5-turbo",
      Confirm: "Confirm",
      Actions: {
        Add: "Add",
        Hide: "Hide",
